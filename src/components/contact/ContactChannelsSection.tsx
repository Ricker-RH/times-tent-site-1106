        ...
        <div className="flex h-full flex-col gap-6">
          ...
          <div className="flex-1 grid content-start gap-4 sm:grid-cols-2">
            {cards.map((card) => (
              ...
              >
                <span className="flex h-11 w-11 items-center justify-center rounded-full bg-[var(--color-brand-primary)]/12 text-[var(--color-brand-primary)]">
                  <ContactIcon name={(card.icon as IconName) ?? "phone"} />
                </span>
