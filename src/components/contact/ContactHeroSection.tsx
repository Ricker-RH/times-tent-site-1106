  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative z-10 mx-auto flex min-h-[420px] w-full max-w-[1200px] flex-col justify-center gap-6 px-4 py-16 text-white sm:px-6 md:py-24 lg:px-8">
        {eyebrow ? (
          <span className="inline-flex w-fit items-center rounded-full bg-white/15 px-5 py-1 text-xs font-semibold uppercase tracking-[0.35em]">
            {eyebrow}
          </span>
        ) : null}
            ...
            <div className="flex flex-wrap gap-4 text-xs font-medium text-white/80">
              {(hero.metrics ?? []).map((metric) => (
                <span
                  ...
                  className="inline-flex items-center gap-3 rounded-full bg-white/10 px-5 py-2 backdrop-blur"
                >
